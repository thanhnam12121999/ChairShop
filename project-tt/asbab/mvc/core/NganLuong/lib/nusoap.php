 ...
 *	RFC 2045 Multipurpose Internet MailSMTP Extensions (MIME) Part One: Format of Internet Message Bodies
...
class soap_transport_http extends nusoap_base {
	...
	* @param array $curl_options Customer-specified cURL options
	...
	*/
	function soap_transport_http($url, $curl_options = NULL, $use_curl = false){
		...
		$this->setHeader('Customer-Agent', $this->title.'/'.$this->version.' ('.$rev[1].')');
	}
...
class wsdl extends nusoap_base {
	...
	var $curl_options = array();	// Customer-specified cURL options
